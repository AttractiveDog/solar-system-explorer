...
const Dashboard = () => {
    ...
    return (
        <div className="relative w-full min-h-screen h-auto bg-[#050510] font-sans overflow-x-hidden overflow-y-auto">
            ...
            <button
                onClick={() => navigate('/')}
                className="absolute top-20 left-4 md:top-24 md:left-6 z-50 flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:bg-white/20 transition-all duration-300 text-white font-display"
            >
            ...
            <div className="absolute top-4 right-16 md:top-6 md:right-36 z-50 flex items-center gap-3 md:gap-4">
                {/* Profile Button */}
                <button
                    onClick={() => navigate('/profile')}
                    className="p-1.5 md:p-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:bg-white/20 transition-all duration-300 group"
                    title="View Profile"
                >
                    <User size={16} className="text-white group-hover:text-cyan-400 transition-colors md:w-5 md:h-5" />
                </button>

                {/* Mission Timer */}
                <div className="text-right">
                    <div className="text-[10px] md:text-xs text-gray-400 font-display tracking-wider">MISSION TIME</div>
                    <div className="text-base md:text-xl font-display text-cyan-400 font-bold tracking-wider">
